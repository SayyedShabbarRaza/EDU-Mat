...
import 'package:school_system/teacher%20app/teacher_view/teacher_auth.dart/teacher_login_screen.dart';
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        SelectLoginWidget1(
                          image: AppImages.learnerimg,
                          borderColor: Color(0x336B4668),
                          title: 'Learner',
                        ...
                        SelectLoginWidget1(
                          ...
                          title: 'Principle',
                          borderColor: Color(0x1A0277BD),
                          color: const Color(0x1A0277BD),
                          voidCallbackAction: () {
                            Get.to(() => PrincipleProfile());
                          },
                        ),
                        const SizedBox(
                          height: 15,
