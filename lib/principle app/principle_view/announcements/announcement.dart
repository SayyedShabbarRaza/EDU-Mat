...
import 'package:school_system/principle%20app/principle_view/add_announcements/add_announcements.dart';
import 'package:school_system/principle%20app/principle_view/add_student/add_student.dart';
import 'package:school_system/principle%20app/principle_view/add_teachers/add_teachers.dart';
...
class PrincipleAnnouncements extends StatelessWidget {
  PrincipleAnnouncements({super.key});
        ...
        children: [
          ...
          Padding(
            ...
            child: PrimaryButton(
              ...
              function: () {
                Get.to(() => PrincipleAddAnnouncements());
              },
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return PrincipleAnnouncementsWidget(
